...
<!--If you want to use the English description, use <p>Given an array of integers <code>arr</code>, return <em>the number of subarrays with an <strong>odd</strong> sum</em>.</p>
...
Question: [LeetCode](https://leetcode.com/problems/number-of-sub-arrays-with-odd-sum/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/number-of-sub-arrays-with-odd-sum/description/)

Solution: [LeetCode](https://leetcode.com/articles/number-of-sub-arrays-with-odd-sum/)  /  [LeetCode中国](https://leetcode-cn.com/articles/number-of-sub-arrays-with-odd-sum/)
